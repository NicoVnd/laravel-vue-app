      ...
      <div class="flex justify-between items-center h-20">
        ...
        <div class="flex items-center space-x-8">
          ...
          <div class="hidden md:flex items-center space-x-8">
            ...
            <a href="/articles" class="text-gray-600 hover:text-[#D4B896] font-medium transition-colors duration-300">Articles</a>
      ...
      <div v-show="isMobileMenuOpen" class="md:hidden pb-6 mb-6 mt-2 bg-white rounded-lg shadow-lg animate-fadeIn">
        <div class="flex flex-col divide-y divide-gray-100">
          <div class="py-2 px-4">
            ...
            <a href="/articles" class="block text-gray-600 hover:text-[#D4B896] font-medium py-3 px-2 rounded-md hover:bg-blue-50 transition-all">
              <span class="flex items-center">
                <svg class="w-5 h-5 mr-2 text-[#1E40AF]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
